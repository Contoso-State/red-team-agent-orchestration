...
.finding-head{display:grid; grid-template-columns:auto 92px minmax(0,1fr) 130px 150px 96px auto; gap:12px; align-items:center; width:100%; text-align:left; background:none; border:none; padding:12px 14px; cursor:pointer; font:inherit; color:var(--txt)}
