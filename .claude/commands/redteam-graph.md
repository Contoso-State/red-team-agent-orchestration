...
- Dependency-free Node runner — `tools/graph/run-graph.mjs` — executes the graph inside every CLI runtime (GitHub Copilot, Claude Code, OpenAI Codex, Cursor) with zero runtime dependencies.
