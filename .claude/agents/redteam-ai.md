...
<!-- This file is GENERATED by tools/agents/build-agent-defs.mjs from the Copilot definitions under .github/. Do not edit by hand — edit the source and re-run the generator. Source: .github/agents/redteam-ai.agent.md -->
...
Skill (domain knowledge): `.claude/skills/azure-redteam-ai/SKILL.md`.
